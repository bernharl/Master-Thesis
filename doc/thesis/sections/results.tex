...
\begin{table}
    \centering
    \caption{Top and bottom four (ranked by median) attributes of the overfit model described earlier 
    ...
    \label{overfit table}
\end{table}
Table \ref{overfit table} shows 5th, 25th, 50th, 75th and 95th percentiles of the importances of the top and bottom four basin attributes of the overfit model according to the permutation test described in Chapter \ref{Feature selection}. We observe stuff and things (need to rerun test lol).
