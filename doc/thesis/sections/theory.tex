...
Qualitatively speaking, a conceptual model like SAC-SMA is designed to model the 
behaviour of the physics behind rainfall-runoff modelling without necessarily 
using actual physical equations known to describe such a system. 
