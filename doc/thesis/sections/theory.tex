...
\begin{figure}
    ...
    \caption{A multilayer perceptron model as described in \citet{rosenblatt1958perceptron}. Figure taken and modified from \citet{neuralnetfig}.}
...
\caption{A single basic LSTM cell as proposed in \citet{hochreiter1997long}. Visually we see the point of the Cell State $C$ here is to not retain more information 
