...
\begin{cases}
	P \cdot \Delta t - W_1^c + W_i^t \left[ N+1 \right], &  i_0 + P \Delta t \geq i_m\\
	P \cdot \Delta t - W_1^c + W_1^t \left[ N+1 \right] \\ + W_1^c \left[  1 - 
    \frac{i_0 + P \cdot \Delta t}{i_m} \right]^{l+b_i}, & i + P \cdot \Delta t \leq i_m
\end{cases}
\end{equation}
To better fit with the notation of this thesis we have gone from the original 
...
\\ \cdot \left( \frac{W_2^t\left[ N+1  \right] - W_sW_2^c}{W_2^c - W_sW_2^c}  \right), 
