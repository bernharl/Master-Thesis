...
the National Water Model (NWA). The NWM is a coupled meteorological forecast model, 
the hydrological component of which is known as the Weather Research and Forecasting 
Hydrological modelling system (WFR-Hydro) \citep{WRF-hydro-guide, WRF-hydro-original}. 
