...
area into $N$ grid points and the ground (vertically) into two soil layers. One 
upper soil layer and one lower soil layer. This is an attempt at physically 
representing underground streamflow.
