...
It is called the Entity Aware LSTM(EA-LSTM) \citet{lstm_second_paper}. The paper 
indicates that this modified LSTM performs worse than the naive approach, going 
from a median NSE of 0.76 to 0.74 on the CAMELS dataset \citep{CAMELS_US}. The 
underlying philosophy of this thesis however still makes us believe that this is 
the model we should employ, as it is the most interpretable model \citep{lstm_second_paper} 
