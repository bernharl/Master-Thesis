...
\begin{align}
    f_t &= \sigma\left(W_f\cdot \left[h_{t-1},x_t\right]+b_f\right) \label{forget gate}\\
    i_t &= \sigma\left(W_i\cdot \left[ h_{t-1}, x_t\right] + b_i\right) \label{input gate}\\
    C_t &= \tanh\left(W_C\cdot \left[ h_{t-1}, x_t  \right] + b_C \right) \label{output gate}
