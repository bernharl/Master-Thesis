...
cfg["test_basin_file"] = Path(
    "/home/bernhard/git/Master-Thesis/runs/correlation_reduction/cross_validation/cross_validation_seed_19970204/basins_test.txt"
)
for i in range(5):
    cfg["run_dir"] = Path(
        f"/home/bernhard/git/Master-Thesis/runs/camels_us/chosen_features_cv_gb/{i}"
    )
