...
for i in range(5):
    cfg["run_dir"] = Path(
        f"/home/bernhard/git/Master-Thesis/runs/combined_dataset//train_gb_val_us/{i}"
    )
    ...
    cfg["val_basin_file"] = Path(
        f"/home/bernhard/git/Master-Thesis/runs/combined_dataset/train_gb_val_us/cv/cross_validation_seed_19970204/{i}/basins_test.txt"
    )
    train(cfg)
