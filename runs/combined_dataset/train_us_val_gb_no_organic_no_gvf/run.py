...
for i in range(0, 5):
    ...
    cfg["train_basin_file"] = Path(
        f"/home/bernhard/git/Master-Thesis/runs/combined_dataset/train_us_val_gb/cv/cross_validation_seed_19970204/{i}/basins_train.txt"
    )
    cfg["val_basin_file"] = Path(
        f"/home/bernhard/git/Master-Thesis/runs/combined_dataset/train_us_val_gb/cv/cross_validation_seed_19970204/{i}/basins_val.txt"
    )
    train(cfg)
